...
const totalTransfers = data.reduce((a,b)=>a + Number(b.transfer_in || 0),0);
const totalAssignments = data.reduce((a,b)=>a + Number(b.assignments || 0),0);
...
const net = Number(row.purchases) + Number(row.transfer_in) - Number(row.transfer_out);
